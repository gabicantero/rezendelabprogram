...
# --- Funções para carregar e salvar dados e projetos ---
...
# --- Controle de estados para formulário adicionar projeto ---
...
# === Página Projects ===
    ...
    # Botão para mostrar/esconder o formulário de adicionar projeto
    ...
    # Mostrar projetos já cadastrados
